  ...
  <div class="bg-white drop-shadow">
    <div class="container flex items-center h-16">
      ...
      <div class="grow max-w-xs">
        <input type="search" class="p-2 bg-gray-100 w-full rounded-md shadow border border-gray-300 text-sm focus:bg-sky-50 focus:border-sky-600 focus:outline-0" placeholder="filter" v-model="query"
               autofocus />
      </div>
    </div>
  </div>
